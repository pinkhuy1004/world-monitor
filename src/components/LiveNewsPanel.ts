...
const _REGION_ENTRIES: { key: string; labelKey: string; channelIds: string[] }[] = [
  ...
  { key: 'asia', labelKey: 'components.liveNews.regionAsia', channelIds: ['astroawani', 'beritartm', 'tbs-news', 'ann-news', 'ntv-news', 'cti-news', 'cgtn', 'wion', 'ndtv', 'cna-asia', 'nhk-world', 'arirang-news', 'india-today', 'abp-news'] },
