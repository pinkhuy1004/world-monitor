...
export const VARIANT_PANEL_OVERRIDES: Partial<Record<string, Partial<Record<string, Partial<PanelConfig>>>>> = {
  malaysia: {
    ...
    'live-news': { name: 'Live Malaysia News' },
    intel:       { name: 'Malaysia Intel Feed' },
    'gdelt-intel': { name: 'Regional Intelligence' },
    cii:         { name: 'Malaysia Instability' },
    politics:    { name: 'Malaysia Politics' },
    tech:        { name: 'Malaysia Technology' },
    ai:          { name: 'Malaysia AI/ML' },
    finance:     { name: 'Malaysia Finance' },
    energy:      { name: 'Malaysia Energy' },
    markets:     { name: 'Bursa Malaysia' },
    'climate-news': { name: 'Crisis & Climate' },
  },
  finance: {
