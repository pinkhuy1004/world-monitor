...
export const shareTexts = {
  twitter: (data: StoryData) =>
    ...
    `\nGenerated by @MalaysiaMonitorApp`,
  ...
  linkedin: (data: StoryData) =>
    ...
    `\nData via Malaysia Monitor - Open source geopolitical intelligence`,
...
export function getShareUrls(data: StoryData): Record<string, string> {
  ...
  return {
    ...
    reddit: `https://reddit.com/submit?url=${encodeURIComponent(url)}&title=${encodeURIComponent(`${data.countryName} Intelligence Brief - Malaysia Monitor`)}`,
